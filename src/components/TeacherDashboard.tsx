...
import { GraduationCap, FileUp, CheckCircle } from 'lucide-react';
import { 
  Form,
  FormField,
  FormItem,
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Upload and manage student results to the blockchain for permanent and tamper-proof record keeping.
        </p>
      </div>
      ...
      <div className="bg-muted/50 p-6 rounded-lg">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          results would be stored on-chain with the full data secured through IPFS.
        </p>
      </div>
    </div>
  );
